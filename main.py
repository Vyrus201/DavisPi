        ...
        def CreateGraph(self):
            ...
            def savearcstate():
                ...
                if startcompare > endcompare:
                    ...
                    DateGraphErrorwin.iconbitmap(f'{workingdir}\\Assets\\icon.ico')
                ...
                if (((date2 - date1).days) > 90):
                    ...
                    DayGraphErrorwin.iconbitmap(f'{workingdir}\\Assets\\icon.ico')
        ...
        def right_click(self, event):
            ...
            for key, value in self.tempsensorconf.items():
                if self.res[0] == self.dataDisplay[key]:
                    ...
                    destroylabelwin.iconbitmap(f'{workingdir}\\Assets\\icon.ico')
                    destroylabelwin.title("Remove Temporary Label")
                    destroylabelwin.geometry('285x150')
